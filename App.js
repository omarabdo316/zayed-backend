...
const DEFAULT_ZONES = {
  ground: [
    { key: 'g_pool', name_ar: 'المسبح', name_en: 'Swimming Pool', wing: 'الخدمات المركزية', x: 140, y: 175, w: 120, h: 48, icon: 'water', color: '#BAE6FD' },
    { key: 'g_gym', name_ar: 'الصالة الرياضية', name_en: 'Gymnasium', wing: 'الخدمات المركزية', x: 130, y: 228, w: 140, h: 68, icon: 'fitness', color: '#DDD6FE' },
    { key: 'g_cafe_1', name_ar: 'كافيتريا 1', name_en: 'Cafeteria 1', wing: 'الخدمات المركزية', x: 132, y: 35, w: 62, h: 72, icon: 'restaurant', color: '#FEF3C7' },
    { key: 'g_cafe_2', name_ar: 'كافيتريا 2', name_en: 'Cafeteria 2', wing: 'الخدمات المركزية', x: 206, y: 35, w: 62, h: 72, icon: 'restaurant', color: '#FEF3C7' },
    { key: 'g_lecture', name_ar: 'غرفة المحاضرات', name_en: 'Lecture Room', wing: 'الخدمات المركزية', x: 145, y: 144, w: 110, h: 28, icon: 'easel', color: '#FBCFE8' },
    { key: 'g_admin_center', name_ar: 'الإدارة المركزية', name_en: 'Central Admin', wing: 'الإدارة', x: 145, y: 355, w: 110, h: 36, icon: 'business', color: '#FEE2E2' },
    { key: 'g_reception', name_ar: 'الاستقبال الرئيسي', name_en: 'Main Reception', wing: 'الإدارة', x: 165, y: 395, w: 70, h: 32, icon: 'log-in', color: '#E2E8F0' },
    { key: 'g_clinic', name_ar: 'العيادة الصحية', name_en: 'Clinic', wing: 'الإدارة', x: 108, y: 355, w: 34, h: 36, icon: 'medkit', color: '#D1FAE5' },
    { key: 'g_c5_1', name_ar: 'صف الخامس 1', name_en: 'Grade 5 - 1', wing: 'جناح الصف الخامس', x: 80, y: 146, w: 38, h: 28, icon: 'school', color: '#FEF08A' },
    { key: 'g_c5_2', name_ar: 'صف الخامس 2', name_en: 'Grade 5 - 2', wing: 'جناح الصف الخامس', x: 42, y: 146, w: 36, h: 28, icon: 'school', color: '#FEF08A' },
    { key: 'g_c5_3', name_ar: 'صف الخامس 3', name_en: 'Grade 5 - 3', wing: 'جناح الصف الخامس', x: 4, y: 146, w: 36, h: 28, icon: 'school', color: '#FEF08A' },
    { key: 'g_c5_4', name_ar: 'صف الخامس 4', name_en: 'Grade 5 - 4', wing: 'جناح الصف الخامس', x: 4, y: 114, w: 36, h: 28, icon: 'school', color: '#FEF08A' },
    { key: 'g_c5_5', name_ar: 'صف الخامس 5', name_en: 'Grade 5 - 5', wing: 'جناح الصف الخامس', x: 42, y: 114, w: 36, h: 28, icon: 'school', color: '#FEF08A' },
    { key: 'g_c5_6', name_ar: 'صف الخامس 6', name_en: 'Grade 5 - 6', wing: 'جناح الصف الخامس', x: 80, y: 114, w: 38, h: 28, icon: 'school', color: '#FEF08A' },
    { key: 'g_c6_1', name_ar: 'صف السادس 1', name_en: 'Grade 6 - 1', wing: 'جناح الصف السادس', x: 282, y: 146, w: 38, h: 28, icon: 'school', color: '#FED7AA' },
    { key: 'g_c6_2', name_ar: 'صف السادس 2', name_en: 'Grade 6 - 2', wing: 'جناح الصف السادس', x: 322, y: 146, w: 36, h: 28, icon: 'school', color: '#FED7AA' },
    { key: 'g_c6_3', name_ar: 'صف السادس 3', name_en: 'Grade 6 - 3', wing: 'جناح الصف السادس', x: 360, y: 146, w: 36, h: 28, icon: 'school', color: '#FED7AA' },
    { key: 'g_c6_4', name_ar: 'صف السادس 4', name_en: 'Grade 6 - 4', wing: 'جناح الصف السادس', x: 360, y: 114, w: 36, h: 28, icon: 'school', color: '#FED7AA' },
    { key: 'g_c6_5', name_ar: 'صف السادس 5', name_en: 'Grade 6 - 5', wing: 'جناح الصف السادس', x: 322, y: 114, w: 36, h: 28, icon: 'school', color: '#FED7AA' },
    { key: 'g_c6_6', name_ar: 'صف السادس 6', name_en: 'Grade 6 - 6', wing: 'جناح الصف السادس', x: 282, y: 114, w: 38, h: 28, icon: 'school', color: '#FED7AA' },
    { key: 'g_c2_1', name_ar: 'صف الثاني 1', name_en: 'Grade 2 - 1', wing: 'جناح الصف الثاني', x: 80, y: 260, w: 38, h: 28, icon: 'school', color: '#BBF7D0' },
    { key: 'g_c2_2', name_ar: 'صف الثاني 2', name_en: 'Grade 2 - 2', wing: 'جناح الصف الثاني', x: 80, y: 292, w: 38, h: 28, icon: 'school', color: '#BBF7D0' },
    { key: 'g_c2_3', name_ar: 'صف الثاني 3', name_en: 'Grade 2 - 3', wing: 'جناح الصف الثاني', x: 42, y: 260, w: 36, h: 28, icon: 'school', color: '#BBF7D0' },
    { key: 'g_c2_4', name_ar: 'صف الثاني 4', name_en: 'Grade 2 - 4', wing: 'جناح الصف الثاني', x: 42, y: 292, w: 36, h: 28, icon: 'school', color: '#BBF7D0' },
    { key: 'g_c2_5', name_ar: 'صف الثاني 5', name_en: 'Grade 2 - 5', wing: 'جناح الصف الثاني', x: 4, y: 260, w: 36, h: 28, icon: 'school', color: '#BBF7D0' },
    { key: 'g_c4_1', name_ar: 'صف الرابع 1', name_en: 'Grade 4 - 1', wing: 'جناح الصف الرابع', x: 282, y: 292, w: 38, h: 28, icon: 'school', color: '#E9D5FF' },
    { key: 'g_c4_2', name_ar: 'صف الرابع 2', name_en: 'Grade 4 - 2', wing: 'جناح الصف الرابع', x: 282, y: 260, w: 38, h: 28, icon: 'school', color: '#E9D5FF' },
    { key: 'g_c4_3', name_ar: 'صف الرابع 3', name_en: 'Grade 4 - 3', wing: 'جناح الصف الرابع', x: 322, y: 292, w: 36, h: 28, icon: 'school', color: '#E9D5FF' },
    { key: 'g_c4_4', name_ar: 'صف الرابع 4', name_en: 'Grade 4 - 4', wing: 'جناح الصف الرابع', x: 322, y: 260, w: 36, h: 28, icon: 'school', color: '#E9D5FF' },
    { key: 'g_c4_5', name_ar: 'صف الرابع 5', name_en: 'Grade 4 - 5', wing: 'جناح الصف الرابع', x: 360, y: 292, w: 36, h: 28, icon: 'school', color: '#E9D5FF' },
    { key: 'g_c4_6', name_ar: 'صف الرابع 6', name_en: 'Grade 4 - 6', wing: 'جناح الصف الرابع', x: 360, y: 260, w: 36, h: 28, icon: 'school', color: '#E9D5FF' },
    { key: 'g_c1_1', name_ar: 'صف الأول 1', name_en: 'Grade 1 - 1', wing: 'جناح الصف الأول', x: 80, y: 365, w: 38, h: 28, icon: 'school', color: '#FED7AA' },
    { key: 'g_c1_2', name_ar: 'صف الأول 2', name_en: 'Grade 1 - 2', wing: 'جناح الصف الأول', x: 80, y: 398, w: 38, h: 28, icon: 'school', color: '#FED7AA' },
    { key: 'g_c1_3', name_ar: 'صف الأول 3', name_en: 'Grade 1 - 3', wing: 'جناح الصف الأول', x: 42, y: 365, w: 36, h: 28, icon: 'school', color: '#FED7AA' },
    { key: 'g_c1_4', name_ar: 'صف الأول 4', name_en: 'Grade 1 - 4', wing: 'جناح الصف الأول', x: 42, y: 398, w: 36, h: 28, icon: 'school', color: '#FED7AA' },
    { key: 'g_c1_5', name_ar: 'صف الأول 5', name_en: 'Grade 1 - 5', wing: 'جناح الصف الأول', x: 4, y: 365, w: 36, h: 28, icon: 'school', color: '#FED7AA' },
    { key: 'g_c1_6', name_ar: 'صف الأول 6', name_en: 'Grade 1 - 6', wing: 'جناح الصف الأول', x: 4, y: 398, w: 36, h: 28, icon: 'school', color: '#FED7AA' },
    { key: 'g_c3_1', name_ar: 'صف الثالث 1', name_en: 'Grade 3 - 1', wing: 'جناح الصف الثالث', x: 282, y: 398, w: 38, h: 28, icon: 'school', color: '#BAE6FD' },
    { key: 'g_c3_2', name_ar: 'صف الثالث 2', name_en: 'Grade 3 - 2', wing: 'جناح الصف الثالث', x: 282, y: 365, w: 38, h: 28, icon: 'school', color: '#BAE6FD' },
    { key: 'g_c3_3', name_ar: 'صف الثالث 3', name_en: 'Grade 3 - 3', wing: 'جناح الصف الثالث', x: 322, y: 398, w: 36, h: 28, icon: 'school', color: '#BAE6FD' },
    { key: 'g_c3_4', name_ar: 'صف الثالث 4', name_en: 'Grade 3 - 4', wing: 'جناح الصف الثالث', x: 322, y: 365, w: 36, h: 28, icon: 'school', color: '#BAE6FD' },
    { key: 'g_c3_5', name_ar: 'صف الثالث 5', name_en: 'Grade 3 - 5', wing: 'جناح الصف الثالث', x: 360, y: 398, w: 36, h: 28, icon: 'school', color: '#BAE6FD' },
    { key: 'g_lab_sci_1', name_ar: 'مختبر العلوم 1', name_en: 'Science Lab 1', wing: 'المختبرات', x: 248, y: 310, w: 38, h: 32, icon: 'flask', color: '#FECDD3' },
    { key: 'g_lab_comp_1', name_ar: 'مختبر الحاسوب 1', name_en: 'Computer Lab 1', wing: 'المختبرات', x: 208, y: 310, w: 38, h: 32, icon: 'hardware-chip', color: '#FECDD3' },
    { key: 'g_lab_comp_2', name_ar: 'مختبر الحاسوب 2', name_en: 'Computer Lab 2', wing: 'المختبرات', x: 154, y: 310, w: 38, h: 32, icon: 'hardware-chip', color: '#FECDD3' },
    { key: 'g_lab_sci_2', name_ar: 'مختبر العلوم 2', name_en: 'Science Lab 2', wing: 'المختبرات', x: 114, y: 310, w: 38, h: 32, icon: 'flask', color: '#FECDD3' },
  ],
  upper: [
...
const styles = StyleSheet.create({
  ...
  zoneTxt: { fontSize: 6.8, fontWeight: 'bold', color: colors.primary, textAlign: 'center', lineHeight: 8 },
